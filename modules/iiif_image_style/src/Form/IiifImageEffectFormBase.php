 ...
 */
abstract class IiifImageEffectFormBase extends FormBase {
   ...
   * @param \Drupal\iiif_image_style\IiifImageStyleInterface $iiif_image_style
   *   The image style.
  ...
  public function buildForm(array $form, FormStateInterface $form_state, IiifImageStyleInterface $iiif_image_style = NULL, $image_effect = NULL) {
    ...
    if (!($this->imageEffect instanceof IiifConfigurableImageEffectInterface)) {
