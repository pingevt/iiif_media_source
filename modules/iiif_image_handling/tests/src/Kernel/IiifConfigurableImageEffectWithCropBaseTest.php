...
/**
 * @coversDefaultClass \Drupal\iiif_image_handling\IiifConfigurableImageEffectWithCropBase
 *
 * Kernel tests for the IiifConfigurableImageEffectWithCropBase class.
 *
 * @group iiif_image_handling
 */
class IiifConfigurableImageEffectWithCropBaseTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    // Install the schema for the crop module.
    $this->installEntitySchema('crop');
    // $this->installSchema('crop', ['crop']);
  }
  ...
  public function testGetCrop(): void {
    ...
    // Use the real crop storage service via entity_type.manager.
    ...
    $effect = $this->getMockForAbstractClass(
      IiifConfigurableImageEffectWithCropBase::class,
      [
        [],
        'plugin_id',
        [],
